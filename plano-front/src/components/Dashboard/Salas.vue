                ...
                <div class="form-group row">
                    <div class="col-sm-10">
                        <template v-if="isEdit">
                            ...
                            <button type="button" class="btn btn-danger m-2 botao-estilo2" v-on:click.prevent="deleteSala" :key="3">Excluir
                            </button>
                            <button type="button" class="btn btn-secondary m-2 botao-estilo2" v-on:click.prevent="cleanSala" :key="2">Cancelar
                            </button>
                        </template>
                        <template v-else>
                            <button type="button" class="btn btn-success m-2 botao-estilo" v-on:click.prevent="addSala" :key="1">Adicionar
                            </button>
                            <button type="button" class="btn btn-secondary m-2 botao-estilo2" v-on:click.prevent="cleanSala" :key="2">Resetar
                            </button>
                        </template>
                    </div>
                </div>
